...
WORK_DIR=`pwd`
echo "WORK_DIR=$WORK_DIR data will be put in $WORK_DIR/data-sort/in"

mkdir -p ${WORK_DIR}/data-sort/in
...
a=${GB}
let L=a*2
./gen_text_data.sh lda_wiki1w $L 2000 5000 ${WORK_DIR}/data-sort/in
